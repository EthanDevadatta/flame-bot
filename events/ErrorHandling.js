...
client.on('error', err => {
    const a = client.channels.cache.get('')
    console.log(
        chalk.yellow('——————————[ERROR]——————————\n') + err
    )
    const ErrorEmbed = new MessageEmbed()
        ...
        .setFooter({
            text: `${process.env.BOT_NAME} Error Handling`,
...
process.on("unhandledRejection", (reason, p) => {
    const b = client.channels.cache.get('')
    console.log(
...
process.on("uncaughtExceptionMonitor", (err, origin) => {
    const d = client.channels.cache.get('')
    console.log(
...
process.on("multipleResolves", (type, promise, reason) => {
    const e = client.channels.cache.get('')
    console.log(
...
process.on("warning", (warn) => {
    const f = client.channels.cache.get('')
    console.log(
